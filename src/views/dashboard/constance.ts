...
import type { INormList } from './types'

export const normList: INormList[] = [
  {
    id: nanoid(),
  ...
  {
    id: nanoid(),
    icon: 'i-material-symbols-stacked-email-outline-rounded',
    label: 'Messages',
    count: 81212,
    color: '#36a3f7',
  },
  {
    id: nanoid(),
    icon: 'i-material-symbols-currency-yen',
    label: 'Purchases',
    count: 9280,
    color: '#f4516c',
  },
